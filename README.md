...
**LLMs • RAG • AI Agents • LangGraph • Transformers • Embeddings • Tool Calling • MCP • PyTorch**
...
**Node.js • Python • FastAPI • Express.js • Redis • MongoDB • PostgreSQL • REST APIs • WebSockets**
